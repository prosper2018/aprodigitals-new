...
<div class="container-fluid  py-4">
    ...
    <div class="col-lg-12">
        <div class="row">
            <!-- FORM Panel -->
            <div class="col-md-4">
                <form id="form1" method="POST" class="simple-example" enctype="multipart/form-data" action="{{ route('loans.types.update', ['id' => $loan->id]) }}" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">&nbsp;
                                ...
                                <input name="display_name" type="text" id="display_name" value="{{ $loan->display_name }}" class="form-control" required>
                                @if($errors->has('display_name')) <span class="text-danger">{{ $errors->first('display_name') }}</span> @endif
                            </div>
                            <div class="form-group py-3">
                                <label class="control-label">Description</label>
                                <textarea name="description" id="" cols="30" rows="2" class="form-control" required>{{ $loan->description }}</textarea>
