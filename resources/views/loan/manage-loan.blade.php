    ...
    <div class="modal fade" id="confirmRejecton" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content" id="reject_modal">
                ...
                <form autocomplete="off" id="form1" onsubmit="return false" class="form-material">
                    <div class="modal-body m-3">
                        <div class="row">

                            <input name="target" value="" id="target" type="hidden">
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <button class="btn btn-lg btn-success" onclick="saveLoanRejection()"> Proceed</button>
