    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3>Payroll Setup Form</h3>
            </div>
            <div class="card-body">
                <form id="form1" method="POST" class="simple-example" enctype="multipart/form-data" action="{{ route('payroll.setup-store') }}" novalidate>
                @csrf
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group p-2">
                                ...
                                <select name="payroll_type" class="form-control custom-select browser-default select" id="">
                                    <option value="" @if(old('payroll_type')=='' ) selected @endif>:::SELECT:::</option>
                                    <option value="1" @if(old('payroll_type')=='1' ) selected @endif>Monthly</option>
                                    <option value="2" @if(old('payroll_type')=='2' ) selected @endif>Semi-Monthly</option>
                                </select>
                            </div>
